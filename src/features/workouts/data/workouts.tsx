...
const workouts: Workout[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        circuit: [
          { name: 'Egyptian', rest: 3, quantity: 5, unit: 'repetitions', image: 'egyptians.png' },
          { name: 'Lunge Twist', rest: 3, quantity: 5, unit: 'repetitions', image: 'lunge-twist.png' },
          { name: 'Standing Leg Circle', rest: 3, quantity: 5, unit: 'repetitions', image: 'standing-leg-circle.png' },
        ],
      },
      {
        type: 'power',
        ...
        circuit: [{ name: 'Split Jump', rest: 20, quantity: 10, unit: 'seconds', image: 'alternate-split-jump.png' }],
      },
      {
        type: 'strength',
        duration: 5,
      ...
      },
      {
        ...
        circuit: [
          ...
          },
          {
            ...
            unit: 'seconds',
            rest: 5,
            image: 'kneeling-hamstring-stretch.png',
          },
          {
